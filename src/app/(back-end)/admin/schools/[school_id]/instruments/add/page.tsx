...
import { getInstrumentsNotInSchool } from "@/lib/server_actions/back_end/dbQueries_INSTRUMENT";
...
const AddSchoolInstruments = ({ params }: any) => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Add Instruments</CardTitle>
      </CardHeader>
      <CardContent>
        <DataTable columns={columns} data={instruments}>
          <Link
            ...
            prefetch={false}
            href={`/admin/schools/${school_id}/instruments`}
          >
            <ChevronLeft />
          </Link>
          <Link
...
export default AddSchoolInstruments;
